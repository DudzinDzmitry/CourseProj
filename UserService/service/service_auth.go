...
import (
	"context"
	"fmt"
	"github.com/DudzinDzmitry/CourseProj/UserService/repository"
...
func (se *Service) CreateUser(ctx context.Context, p *user.Person) (string, error) {
...
func (se *Service) CreateJWT(ctx context.Context, rps repository.Repository, person *user.Person) (accessTokenStr, refreshTokenStr string, err error) {
